"use strict";/* sspg v.0.2.20 built: Wed Sep 23 2015 14:50:58 GMT-0400 (EDT) */var undertone = function(){}; (function(window, myWin){
var n,r=window;
...
k,h){a.o=a.f.getElementsByTagName("body")[0];if(a.friendlyFrame||!e&&!a.Ta){var g=!0;try{var l=a.f.createElement("div");a.o.appendChild(l);b();a.o.removeChild(l)}catch(p){g=!1}e=g}e?c(f,k,h):d[d.length]={fn:f,ctxt:h,args:k}}}}
function ia(a){this.e=this.o=this.f=null;this.Ua="c-";this.Va="BACKGROUND";this.Za="__utc__=1";this.U=function(){return this.D&&this.f.domain&&this.f.domain!=this.e.location.host?!0:!1};this.i="__UT__";this.j=this.D=!1;this.aa=function(a,c){var b={},g={},e=a.match(/Web[kK]it[\/]{0,1}([\d.]+)/),d=a.match(/(Android);?[\s\/]+([\d.]+)?/),m=!!a.match(/\(Macintosh\; Intel /),u=a.match(/(iPad).*OS\s([\d_]+)/),q=a.match(/(iPod)(.*OS\s([\d_]+))?/),A=!u&&a.match(/(iPhone\sOS)\s([\d_]+)/),v=a.match(/(webOS|hpwOS)[\s\/]([\d.]+)/),
Za=/Win\d{2}|Windows/.test(c),ra=a.match(/Windows Phone ([\d.]+)/),$a=v&&a.match(/TouchPad/),sa=a.match(/Kindle\/([\d.]+)/),ba=a.match(/Silk\/([\d._]+)/),ca=a.match(/(BlackBerry).*Version\/([\d.]+)/),J=a.match(/(BB10).*Version\/([\d.]+)/),ta=a.match(/(RIM\sTablet\sOS)\s([\d.]+)/),ua=a.match(/PlayBook/),K=a.match(/Chrome\/([\d.]+)/)||a.match(/CriOS\/([\d.]+)/),T=a.match(/Firefox\/([\d.]+)/),U=a.match(/MSIE\s([\d.]+)/)||a.match(/Trident\/[\d](?=[^\?]+).*rv:([0-9.].)/),va=!K&&a.match(/(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/),
wa=va||a.match(/Version\/([\d.]+)([^S](Safari)|[^M]*(Mobile)[^S]*(Safari))/);if(g.webkit=!!e)g.version=e[1];d&&(b.android=!0,b.version=d[2]);A&&!q&&(b.ios=b.iphone=!0,b.version=A[2].replace(/_/g,"."));u&&(b.ios=b.Db=!0,b.version=u[2].replace(/_/g,"."));q&&(b.ios=b.Eb=!0,b.version=q[3]?q[3].replace(/_/g,"."):null);ra&&(b.wp=!0,b.version=ra[1]);v&&(b.webos=!0,b.version=v[2]);$a&&(b.touchpad=!0);ca&&(b.blackberry=!0,b.version=ca[2]);J&&(b.bb10=!0,b.version=J[2]);ta&&(b.rimtabletos=!0,b.version=ta[2]);
ua&&(g.playbook=!0);sa&&(b.kindle=!0,b.version=sa[1]);ba&&(g.silk=!0,g.version=ba[1]);!ba&&b.android&&a.match(/Kindle Fire/)&&(g.Ib=!0);K&&(g.chrome=!0,g.version=K[1]);T&&(g.firefox=!0,g.version=T[1]);U&&(g.ie=!0,g.version=U[1]);wa&&(m||b.ios||Za)&&(g.safari=!0,b.Cb||(g.version=wa[1]));va&&(g.webview=!0);b.tablet=!!(u||ua||d&&!a.match(/Mobile/)||T&&a.match(/Tablet/)||U&&!a.match(/Phone/)&&a.match(/Touch/));b.phone=!(b.tablet||b.ipod||!(d||A||v||ca||J||K&&a.match(/Android/)||K&&a.match(/CriOS\/([\d.]+)/)||
T&&a.match(/Mobile/)||U&&a.match(/Touch/)));return{os:b,browser:g}};if("undefined"==typeof window.Sa||null==window.Sa)try{this.e=window,this.f=a?"undefined"!=typeof window.parent.document?window.parent.document:window.document:window.document}catch(b){this.e=window,this.f=window.document}else this.e=window.Lb,this.f=window.Sa;this.o=this.f.getElementsByTagName("body")[0];this.aa=this.aa(navigator.userAgent,navigator.platform);if(this.D=-1!=this.e.navigator.appVersion.indexOf("MSIE")?!0:!1){for(var c=
...
k||!1;d=d||!1;if(a){var h=b.f.createElement("script");h.type="text/javascript";h.onreadystatechange=h.onload=function(){var a=h.readyState;!d||k&&k()||("undefined"==typeof h.addEventListener||a)&&!/loaded/.test(a)||(setTimeout(d,0),d=!1,h.onreadystatechange=h.onload=function(){})};e=b.e.setTimeout(function(){f()},e);h.src=a;b.o.appendChild(h);h.async=!1;return e}return null}}
...
if(g)if(v)for(;g--;)q[g].call(this,h[v+l[0]]);else for(;g--;)q[g].call(this,a)}var h=a.document,g=["webkit","ms","o","moz","khtml"],l=["VisibilityState","visibilitychange","Hidden"],p=["focus","blur"],m=[],u=[],q=[],A=[],v="";return{C:function(){a:if(!v){var a,c;for(a=0;c=g[a++];)if(c+l[2]in h){v=c;break a}}b()},qb:function(a){"function"==typeof a&&m.push(a)},pb:function(a){"function"==typeof a&&u.push(a)}}}
...
apfs_start:1,apfs_pause:1,apfs_firstQuartile:1,apfs_midpoint:1,apfs_thirdQuartile:1,apfs_complete:1,ready:1,start:1,interaction:1,autoclose:1,close:1,ERROR:1};this.ignoredElements={CLOSE_BUTTON:1};this.da={};this.T=!1;this.H={};this.r=null;this.L=1E4;this.F="";this.K=!1;this.Ca="br";this.u=function(){var a=window.top.innerHeight||window.top.document.documentElement.clientHeight;200>a&&window.top.screen&&window.top.screen.availHeight&&(a=window.top.screen.availHeight);return a};this.ea=function(){return window.top.innerWidth||
...
var g=this,b=mraid.getState();"expanded"==b||"default"==b?mraid.isViewable()?g.start&&g.start():a():mraid.addEventListener("ready",a)};this.Da=function(){try{var a=this;if(d.isBookmark)a.start&&a.start();else if(a.a.F&&!a.a.K)a.Ga();else if(e){var g=[],b=0;try{b=this.a.ea()}catch(c){}e.mobile&&e.mobile.length&&768>b?g=e.mobile:e.alternate&&e.alternate.length&&768<=b?g=e.alternate:e.mobile||e.alternate||(g=e);0<g.length?a.P.nb(g,function(){a.domReady.ready(function(){a.a.j?a.ga():a.start&&a.start()})}):
a.domReady.ready(function(){a.a.j?a.ga():a.start&&a.start()})}else a.domReady.ready(function(){a.a.j?a.ga():a.start&&a.start()})}catch(f){}};if(d){"undefined"!=typeof d.trackingDebugFunction&&(this.a.la=d.trackingDebugFunction);"undefined"!=typeof d.closeDebugFunction&&(this.a.Z=d.closeDebugFunction);"undefined"!=typeof d.encodeClickUrl&&(this.a.ya=!!d.encodeClickUrl);"undefined"==typeof d.autoCloseTimePeriod||isNaN(d.autoCloseTimePeriod)||(this.a._autoCloseTimePeriod=parseInt(d.autoCloseTimePeriod.toString()));
"undefined"==typeof d.publisherFixTimePeriod||isNaN(d.publisherFixTimePeriod)||(this.a.L=parseInt(d.publisherFixTimePeriod.toString()));"undefined"!=typeof d.utPatchURL&&d.utPatchURL&&(this.a.F=d.utPatchURL.toString());for(var h in{ignoredElements:1,ignoredEvents:1})if(d[h]&&"object"==typeof d[h])for(var g in d[h])this.a[h][g]=1;if("string"==typeof d.thirdPartyTrackers)try{d.thirdPartyTrackers=ka(d.thirdPartyTrackers)}catch(l){confif.thirdPartyTrackers=""}if(d.thirdPartyTrackers&&"object"==typeof d.thirdPartyTrackers){this.a.r=
{};for(var p in d.thirdPartyTrackers)if(f=d.thirdPartyTrackers[p],this.a.r[p]=this.a.r[p]||{},f&&"object"==typeof f)for(var m in f)this.a.r[p][m]=f[m].concat()}}this.P=new ja(this.a);this.domReady=new ha(this.a);this.H=xa(this.a.e);this.H.C();this.Y=function(a){return this.a.Y(a)};this.wa=function(a){return this.a.wa(a)};this.ab=function(a){this.H&&this.H.qb(a)};this.$a=function(a){this.H&&this.H.pb(a)};this.ready=function(a,g,b){this.domReady.ready(a,g,b)};this.ia=function(){var a=this;a.a.S();a.a.M=
0;a.a.I=a.a.oa?a.a.e.setInterval(function(){a.a.M++;a.sendFormatMessage("-kv-act-"+a.a.M);a.a.M*a.a.sa>=a.a._autoCloseTimePeriod&&a.ta()},a.a.sa):a.a.e.setTimeout(function(){a.ta()},a.a._autoCloseTimePeriod);a.sendFormatMessage("-t-resetAutoCloseTimer")}}function Aa(a){if(!Ba.test(a))return a;-1!=a.indexOf("&")&&(a=a.replace(Ca,"&amp;"));-1!=a.indexOf("<")&&(a=a.replace(Da,"&lt;"));-1!=a.indexOf(">")&&(a=a.replace(Ea,"&gt;"));-1!=a.indexOf('"')&&(a=a.replace(Fa,"&quot;"));return a}
var Ca=/&/g,Da=/</g,Ea=/>/g,Fa=/\"/g,Ba=/[&<>\"]/;function Ga(a,b){return a<b?-1:a>b?1:0}var x,Ha,y,Ia;function Ja(){return r.navigator?r.navigator.userAgent:null}Ia=y=Ha=x=!1;var z;if(z=Ja()){var Ka=r.navigator;x=0==z.indexOf("Opera");Ha=!x&&-1!=z.indexOf("MSIE");y=!x&&-1!=z.indexOf("WebKit");Ia=!x&&!y&&"Gecko"==Ka.product}var La=x,B=Ha,C=Ia,D=y;function Ma(){var a=r.document;return a?a.documentMode:void 0}var E;
...
function eb(a){var b=a.length;if(0<b){for(var c=Array(b),e=0;e<b;e++)c[e]=a[e];return c}return[]}function fb(a,b,c){return 2>=arguments.length?I.slice.call(a,b):I.slice.call(a,b,c)}function L(a,b){this.type=a;this.currentTarget=this.target=b}L.prototype.ha=!1;L.prototype.defaultPrevented=!1;L.prototype.preventDefault=function(){this.defaultPrevented=!0};function gb(a){gb[" "](a);return a}gb[" "]=function(){};function M(a,b){a&&this.C(a,b)}ga(M,L);n=M.prototype;n.target=null;n.relatedTarget=null;
n.offsetX=0;n.offsetY=0;n.clientX=0;n.clientY=0;n.screenX=0;n.screenY=0;n.button=0;n.keyCode=0;n.charCode=0;n.ctrlKey=!1;n.altKey=!1;n.shiftKey=!1;n.metaKey=!1;n.B=null;
n.C=function(a,b){var c=this.type=a.type;L.call(this,c);this.target=a.target||a.srcElement;this.currentTarget=b;var e=a.relatedTarget;if(e){if(C){var d;a:{try{gb(e.nodeName);d=!0;break a}catch(f){}d=!1}d||(e=null)}}else"mouseover"==c?e=a.fromElement:"mouseout"==c&&(e=a.toElement);this.relatedTarget=e;this.offsetX=D||void 0!==a.offsetX?a.offsetX:a.layerX;this.offsetY=D||void 0!==a.offsetY?a.offsetY:a.layerY;this.clientX=void 0!==a.clientX?a.clientX:a.pageX;this.clientY=void 0!==a.clientY?a.clientY:
...
n.preventDefault=function(){M.Ab.preventDefault.call(this);var a=this.B;if(a.preventDefault)a.preventDefault();else if(a.returnValue=!1,bb)try{if(a.ctrlKey||112<=a.keyCode&&123>=a.keyCode)a.keyCode=-1}catch(b){}};var N={},O={},P={},Q={};
function R(a,b,c,e,d){if(b)if("array"==s(b))for(var f=0;f<b.length;f++)R(a,b[f],c,e,d);else{e=!!e;var k=O;b in k||(k[b]={q:0,w:0});k=k[b];e in k||(k[e]={q:0,w:0},k.q++);var k=k[e],h=w(a),g;k.w++;if(k[h])for(g=k[h],f=0;f<g.length;f++){if(k=g[f],k.J==c&&k.fa==d){if(k.G)break;return}}else g=k[h]=[],k.q++;f=hb();f.src=a;k=new Ua;k.C(c,f,a,b,e,d);c=k.key;f.key=c;g.push(k);N[c]=k;P[h]||(P[h]=[]);P[h].push(k);a.addEventListener?a!=r&&a.jb||a.addEventListener(b,f,e):a.attachEvent(b in Q?Q[b]:Q[b]="on"+b,
...
function W(a,b,c,e,d,f,k,h){this.log=function(){};h||(h={});h.waitForDOMLoaded=!0;if(h.inIframe||h.inFrameBuster)h.friendlyFrame=!0;h.leaveBehindHeight=parseInt(h.leaveBehindHeight,10);h.leaveBehindWidth=parseInt(h.leaveBehindWidth,10);h.O=!1;0<h.leaveBehindHeight&&0<h.leaveBehindWidth&&(h.O=!0);za.call(this,d,e,f,c,h);this.a.Bb=!0;this.a.oa=h.useAutoCloseInterval;this.a.Ha=h.manualACTStart;this.a.xa=h.delayClose;this.a.m=null;this.a.Ya="ut_lb_";this.a.l="closed";this.a.X=!1;this.a.A=this.a.u();this.a.cb=
this.a.ea();this.a.g=this.a.A;this.a.Ra=["position:absolute;top:-200%;margin:0;padding:0;display:block;border:none;height:0;width:100%;height: 100%;z-index:2147483647;","position:fixed;margin:0;padding:0;display:block;border:none;width:100%;height: 100%;top: 0;left:0;z-index:2147483647;"];this.a.d=null;this.a.b=null;this.a.W=!1;this.na=function(){var a=this.a.o.clientWidth||this.a.cb;if(this.a&&(629<this.a.A||767<a))return!1;var a=!1,b=navigator.userAgent||navigator.vendor||window.opera;if(/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i.test(b)||
...
4)))a=!0;return a};this.V=function(){if("opened"==this.a.l){this.a.ub=this.a.g;var a=this.a.ea(),b=this.a.g=this.a.u(),c=this.a.U();try{this.a.D&&c&&(this.a.g+=10);if(!this.na()||b>this.a.g)this.a.g=b,this.n(b);null!==this.a.b&&(c||(this.a.b.t||(this.a.b.contentWindow?this.a.b.t=this.a.b.contentWindow.document:this.a.b.contentDocument?this.a.b.t=this.a.b.contentDocument.document:this.a.b.document&&(this.a.b.t=this.a.b.document)),this.a.p||(this.a.p=this.a.b.t.getElementById("ut_iframe_reveal")),this.a.p.style.width=
a+"px",this.a.p.style.height=this.a.g+"px"),this.a.b.style.width=a+"px",this.a.b.style.height=this.a.g+"px",this.c.style.height=this.a.g+"px",this.v.style.height=this.a.g-1+"px")}catch(d){}}else if(this.a.qa||!h.autoexpand)this.a.d.style.visibility="none",this.Na(),this.La(),this.a.d.style.visibility="visible",this.n(h.leaveBehindHeight);this.sendFormatMessage("-t-afterwindowresize")};this.yb=function(){setTimeout(function(){window.scrollTo(0,1)})};this.N=0;this.Ba=function(){var a=this;a.yb();a.a.u()==
(a.a.ub||a.a.g)&&a.N&&5>a.N?(a.N++,setTimeout(function(){a.Ba()},100)):setTimeout(function(){a.n();a.V();setTimeout(function(){a.n();a.V();a.N=0;setTimeout(function(){a.n()},1500)},400)},40)};this.ib=function(){var g=this;this.a.d=sb("div",{id:"ut_container"+this.a.s,name:"ut_container"+this.a.s,className:"ut_container",style:this.a.Ra[0]});this.a.m?vb(this.a.m,this.a.d):vb(this.a.o,this.a.d);this.a.Fa=this.a.e.top;this.a.D&&""!==b&&(a=b);if(this.a.U()){var c="?";if(-1<a.indexOf("?")||-1<a.indexOf("&"))c=
"&";a+=c+this.a.Za;this.a.b=this.a.f.createElement("iframe");this.a.b.src=a;this.a.g+=10;this.a.b.frameBorder="0";this.a.d.appendChild(this.a.b)}else this.a.b=new wb(this.a.d,'<iframe src="'+a+'" id="ut_iframe_reveal" name="ut_iframe_reveal" class="ut_iframe_reveal" scrolling="no" frameborder="0" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true" allowTransparency="true" style="margin:0;padding:0;display:block;border:none;position: relative;height: 100%;width: 100%;max-width: 100%;-webkit-backface-visibility: hidden;"></iframe>'),
this.a.Fa=this.a.b.contentWindow;this.a.b.name="ut_iframe_reveal"+this.a.s;this.a.b.id="ut_iframe_reveal"+this.a.s;this.a.b.frameBorder="0";this.a.b.scrolling="no";this.a.b.className="ut_iframe_reveal";this.a.b.setAttribute("allowfullscreen","true");this.a.b.setAttribute("mozallowfullscreen","true");this.a.b.setAttribute("webkitallowfullscreen","true");this.a.b.setAttribute("allowtransparency","true");this.a.b.style.margin=0;this.a.b.style.padding=0;this.a.b.style.display="none";this.a.b.style.border=
"none";this.a.b.style.position="absolute";this.a.b.style.top=0;this.a.b.style.left=0;this.a.b.style.height="100%";this.a.b.style.width="100%";this.a.b.style.maxWidth="100%";this.a.b.style.webkitBackfaceVisibility&&(this.a.b.style.webkitBackfaceVisibility="hidden");this.ab(function(){"opened"==g.a.l&&g.a.ka();g.sendFormatMessage("-t-visibleaction")});this.$a(function(){"opened"==g.a.l&&g.a.ca();g.sendFormatMessage("-t-hiddenaction")});R(this.a.e.top,"scroll",function(){console.log("scrolling",g.c.h);
void 0!=g.c.h&&(console.log("here",g.Aa()),window.scrollTo(0,g.c.h),g.n())},!1);R(this.a.Fa,"message",function(a){g.handleMessage(a)},!1);R(this.a.e.top,"orientationchange",function(){g.sendFormatMessage("-t-beforeorientationchange");g.Ba();g.sendFormatMessage("-t-afterorientationchange")},!1);R(this.a.e.top,"resize",function(){g.sendFormatMessage("-t-beforewindowresize");g.V()},!1)};this.Aa=function(){if("undefined"!=typeof pageYOffset)return pageYOffset;var a=document.body,b=document.documentElement,
b=b.clientHeight?b:a;return b.scrollTop};this.rb=function(){if(h.friendlyFrame){for(var a,b=this.a.e.top.document.getElementsByTagName("iframe"),c=0;c<b.length;c++)if(b[c].getAttribute("src"))try{if((b[c].contentDocument||b[c].contentWindow.document).getElementById("ut_lb_"+this.a.s)){a=b[c];break}}catch(d){}if(!a)throw"no parent iframe found";a.style.display="none";this.a.m=sb("div",{id:"ut_lb_"+this.a.s,name:"ut_lb_"+this.a.s,className:"ut_lb"});a.parentNode&&a.parentNode.insertBefore(this.a.m,
a.nextSibling)}else this.a.m=this.a.f.getElementById(this.a.Ya+this.a.s)};this.start=function(){var b=this;b.log("start called",this.a.X);this.a.X||(this.a.j&&(mraid.useCustomClose(!0),mraid.setExpandProperties({lockOrientation:"true"})),this.a.X=!0,h.O&&(this.rb(),this.a.m.style.height=h.Gb+"px",this.a.m.style.width=h.Hb+"px"),""!==a?(b.log("embedding ad"),this.a.l="closed",this.c=this.a.e.top.document.getElementsByTagName("body")[0],this.vb=this.c.style.cssText,this.v=this.a.e.top.document.getElementsByTagName("html")[0],
this.wb=this.v.style.cssText,b.a.W=b.na(),this.ib(),h.pgEffect||b.n(),b.domReady.ready(function(){if(h.autoexpand&&!h.pgEffect)b.a.A=b.a.u(),b.a.g=b.a.A,b.c.scrollTop?b.c.h=b.c.scrollTop:b.a.f.scrollTop?b.c.h=b.a.f.scrollTop:b.a.f.documentElement.scrollTop?(b.c.h=b.a.f.documentElement.scrollTop,b.c.ja=!0):b.c.h="0",b.c.ja&&window.scrollTo(0,b.c.h);else if(h.pgEffect){b.tb=(new Date).getTime();"flux"==h.pgEffect&&(b.c.style.backgroundColor=h.backgroundColor);var a={background:void 0,onrendered:function(a){b.sb=
(new Date).getTime();"custom"==h.pgEffect&&(b.eb=a.toDataURL());b.Oa=a;b.Ka&&b.open()}},c=function(){if("function"==typeof html2canvas){if(h.screenshotConfig)for(var d in h.screenshotConfig)a[d]="proxy"!==d||"proxy"==d&&"string"==typeof h.screenshotConfig.proxy?h.proxy:"http://h2cp.herokuapp.com/:8008";b.a.A=b.a.u();b.a.g=b.a.A;b.c.scrollTop?b.c.h=b.c.scrollTop:b.a.f.scrollTop?b.c.h=b.a.f.scrollTop:b.a.f.documentElement.scrollTop?(b.c.h=b.a.f.documentElement.scrollTop,b.c.ja=!0):b.c.h="0";b.n(b.a.g);
setTimeout(function(){html2canvas(b.a.o,a)},0);b.c.ja&&window.scrollTo(0,b.c.h)}else setTimeout(c,20)};c()}else b.a.j||b.close(!0)})):b.k("ERROR","STARTING_NO_CREATIVE_HTML"))};this.n=function(a){a||(a=this.a.u());this.a.j&&(a=window.innerHeight?window.innerHeight:document.body&&document.body.offsetHeight?document.body.offsetHeight:0);this.a.g=a;this.a.d?this.a.d.style.height=a+"px":console.log("no self.model.container");(this.c.h||0===this.c.h)&&this.a.e.top.scrollTo(0,this.c.h);this.a.b.style?(this.a.b.style.display=
"block",this.a.b.style.height=a+"px"):console.log("no self.model.ut_iframe_reveal.style");!this.a.U()&&this.a.b.t&&(this.a.p||(this.a.p=this.a.b.t.getElementById("ut_iframe_reveal")),this.a.p.style.height=a+"px");"closed"!=this.a.l&&(this.c.style.height=a+"px",this.v.style.height=a-1+"px");this.ma()};this.ma=function(){var a={message:this.a.i+"heightUpdate"};a.height=this.a.g;a.expandHeight=this.a.g;this.a.W&&a.height++;this.sendFormatMessage(la(a),!1)};this.fb=function(){var a=this.a.u();this.c.style.height=
a+"px";this.v.style.height=a-1+"px";this.v.style.overflow="hidden";this.v.style.display="block";this.c.style.display="block";this.a.b.style.height=a+"px";this.a.d.style.height=a+"px"};this.end=function(){this.a.d&&this.a.d.parentNode&&this.a.d.parentNode.removeChild(this.a.d);"defined"!==typeof window.PUBLISHER_FIX_LOADED&&delete window.PUBLISHER_FIX_LOADED};this.a.FORMAT="sspg";this.a.l="closed";this.a.ra=!1;this.a.qa=!1;this.a.s=parseInt(k.toString());this.a.d=null;this.Pa={self:this,custom:function(){var a=
this.self;a.sendFormatMessage("-kv-scrollTop-"+a.c.h);a.sendFormatMessage("-pg-"+a.eb);a.sendFormatMessage("-kv-time-"+(a.sb-a.tb));a.Qa()}};this.Qa=function(){var a=this;a.log("showAd");setTimeout(function(){a.a.b.style.visibility="hidden";setTimeout(function(){a.a.b.style.visibility="visible";a.a.d.style.cssText=a.a.Ra[1];a.a.d.style.top=a.c.h+"px";a.a.d.style.display="block";a.a.m&&(a.a.d.style.width=a.a.o.getBoundingClientRect().width+"px",a.a.d.style.height=a.a.o.getBoundingClientRect().height+
"px");a.a.d.className="";a.a.d.className="ut_container ut_open";a.a.l="opened";setTimeout(function(){a.n();a.V();a.ma();a.sendFormatMessage("expanded");h.manualACTStart||0===h.autoCloseTimePeriod||a.ia();a.a.ka()},20)},20)},20)};this.open=function(){var a=this;a.Ka=!0;(a.a.W||-1!=navigator.userAgent.indexOf("Safari")&&-1==navigator.userAgent.indexOf("Chrome"))&&setTimeout(function(){a.fb()},40);a.a.qa=!0;a.c.h=a.Aa();a.a.ra?this.k("replay",this.a.FORMAT):(a.zb(),a.k("start",a.a.FORMAT));if(!h.pgEffect)a.Qa();
else if(html2canvas&&a.Oa)if(a.Pa[h.pgEffect])a.Pa[h.pgEffect]();else throw Error('SSPG does not recognize the "'+h.pgEffect+'" effect');};this.Xa=this.info;this.info=function(a,b,c){c=c||{};c.isFullPageFlex=this.na();c.pgEffect=h.pgEffect;c.expandHeight=this.a.g;c.leaveBehindHeight=h.leaveBehindHeight;c.leaveBehindWidth=h.leaveBehindWidth;return this.Xa(a,b,c)};this.close=function(a){this.a.ca();this.a.S();a||this.k("close",this.a.FORMAT);this.a.l="closed";this.c.h=null;S(this.a.e.top,"scroll");
S(this.a.e.top,"resize");S(this.a.e.top,"orientationchange");!h.O&&this.a.j&&mraid.close();this.gb()};this.gb=function(){this.c.style.cssText=this.vb;this.c.style.marginTop="";this.v.style.cssText=this.wb;h.O?(this.a.d.style.visibility="none",this.Na(),this.La(),this.n(h.leaveBehindHeight),this.ma(),this.a.d.style.visibility="visible",this.a.m&&(this.a.d.style.top="0px",this.a.d.style.position="absolute",this.a.d.style.left="0px")):this.a.d.style.display="none";this.a.d.className="";this.a.d.className=
"ut_container ut_closed";this.sendFormatMessage("-t-closeAd");this.sendFormatMessage("close");null!==this.a.Z&&this.a.Z()};this.La=function(){var a=this.lb(this.a.m);this.a.d.style.left=a[0]+"px";this.a.d.style.top=a[1]+"px"};this.Na=function(){this.a.b.style.width=h.leaveBehindWidth+"px";this.a.b.style.height=h.leaveBehindHeight+"px";this.a.d.style.height=h.leaveBehindHeight+"px";this.a.d.style.width=h.leaveBehindWidth+"px";!this.a.U()&&this.a.b.t&&(this.a.p||(this.a.p=this.a.b.t.getElementById("ut_iframe_reveal")),
this.a.p.style.width=h.leaveBehindWidth+"px",this.a.p.style.height=h.leaveBehindHeight+"px")};this.lb=function(a){var b=0,c=0;if("undefined"!=typeof a.offsetParent){do b+=a.offsetLeft,c+=a.offsetTop;while(a=a.offsetParent)}return[b,c]};this.Wa=this.handleMessage;this.handleMessage=function(a){if(a&&"object"==typeof a&&a.B){var b=a.B,c=!0;if(b.data==this.a.i+"opened"||b.data==this.a.i+"start")c=!1,h.autoexpand&&b.data==this.a.i+"start"||b.data==this.a.i+"opened"?this.Oa||!h.pgEffect?this.open():this.Ka=
!0:this.close(!0);else if(b.data==this.a.i+"closed")c=!1,this.sendFormatMessage("scroll"),this.close(!1);else if(b.data==this.a.i+"scrollToTop")window.scrollTo(0,1);else if(b.data!=this.a.i+"ready"&&b.data!=this.a.i+"startACT"){try{var d=ka(b.data)}catch(e){return}d.message&&-1<d.message.toUpperCase().indexOf("REDIRECT")?(this.a.ca(),this.a.kb(),h.manualACTStart||"opened"!=this.a.l||0===h.autoCloseTimePeriod||this.a.j||this.ia()):"opened"==this.a.l&&d.message&&!this.Y(d.message.replace(this.a.i,""))&&
d.target&&this.a.ka()}c&&this.Wa(a)}};this.zb=function(){this.a.ra=!0};this.Da()}ga(W,za);myWin.ut_bannerid=myWin.ut_bannerid||0;var X={ignoredElements:myWin.ut_ignoredElements||{},ignoredEvents:myWin.ut_ignoredEvents||{},thirdPartyTrackers:myWin.ut_thirdPartyTrackers||{},utPatchURL:myWin.ut_patchUrl||"",backgroundColor:myWin.ut_backgroundColor||"#fff",autoexpand:1};"undefined"!=typeof myWin.ut_pubWidth&&(X.pubWidth=myWin.Kb);
"undefined"!=typeof myWin.ut_trackingDebugFunction&&(X.trackingDebugFunction=myWin.ut_trackingDebugFunction);"undefined"!=typeof myWin.ut_closeDebugFunction&&(X.closeDebugFunction=myWin.ut_closeDebugFunction);"undefined"!=typeof myWin.ut_encodeClickUrl&&(X.encodeClickUrl=myWin.ut_encodeClickUrl);"undefined"!=typeof myWin.ut_autocloseTimePeriod&&(X.autoCloseTimePeriod=myWin.ut_autocloseTimePeriod);"undefined"!=typeof myWin.ut_pgEffect&&(X.pgEffect=myWin.ut_pgEffect);
"undefined"!=typeof myWin.ut_screenshotConfig&&(X.screenshotConfig=myWin.ut_screenshotConfig);"undefined"!=typeof myWin.ut_fr&&(X.inIframe=!!parseInt(myWin.ut_fr,0));"undefined"!=typeof myWin.ut_fb&&(X.inFrameBuster=!!parseInt(myWin.ut_fb,0));"undefined"!=typeof myWin.ut_patchMaxLoadTime&&(X.publisherFixTimePeriod=myWin.ut_patchMaxLoadTime);"undefined"!=typeof myWin.ut_iconLocation&&(X.iloc=myWin.ut_iconLocation);"undefined"!=typeof myWin.ut_autoexpand&&(X.autoexpand=myWin.ut_autoexpand);
...
new W(myWin.ut_creativehtml,myWin.Jb||"",myWin.ut_imagearray||[],myWin.ut_clickBase,myWin.ut_eventBase,myWin.ut_clickTags,myWin.ut_bannerid,X);var Y=["undertone","formats","Sspg"],Z=window||r;Y[0]in Z||!Z.execScript||Z.execScript("var "+Y[0]);for(var $;Y.length&&($=Y.shift());){var xb;if(xb=!Y.length)xb=void 0!==W;xb?Z[$]=W:Z=Z[$]?Z[$]:Z[$]={}};
